        ...
        switch ($_GET['pg']) {
            ...
            case 'sanphamchitiet':
                if (isset($_GET['idpro'])) {
                    ...
                    $idsp=$_GET['idpro'];
                    $dsbl=binh_luan_select_by_sanpham($idsp);
            ...
            case 'tintucchitiet':
                if (isset($_GET['idtt'])) {
                    ...
                    $dstt=tin_tuc_select_4_except_id($id);
            ...
            case 'add_comment':
                if (isset($_POST["add_comment"])) {
                    ...
                    binh_luan_insert($iduser, $idsp, $noidung);
                    header('location: index.php?pg=sanphamchitiet&idpro=' . $idsp);
                }
                    break;
            default:
                include './VIEW/home.php';
